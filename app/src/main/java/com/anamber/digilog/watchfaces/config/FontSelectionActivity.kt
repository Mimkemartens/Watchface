...
class FontSelectionActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fontSelectionRecyclerViewAdapter = FontSelectionRecyclerViewAdapter(
            ...
            BaseConfigData.getFontOptionsDataSet(assets)
        )
        ...
        mConfigAppearanceWearableRecyclerView.adapter = fontSelectionRecyclerViewAdapter
    }
}