...
class PentagonConfigData : BaseConfigData() {
    companion object {
        val PREFERENCE_FILE_KEY = R.string.watch_face_pentagon_preference_file_key

        /**
         * Returns Watch Face Service class associated with configuration Activity.
         */
        val watchFaceServiceClass: Class<*>
            get() = PentagonWatchFaceService::class.java
